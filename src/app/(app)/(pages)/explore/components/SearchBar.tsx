...
const SearchBar: React.FC<SearchBarProps> = ({ value, onChange, onLocationClick }) => {
  return (
    <div className='flex-1 flex items-center gap-2 bg-light-card  dark:bg-dark-card rounded-xl px-4 py-2 focus-within:ring-2 focus-within:ring-light-primary dark:focus-within:ring-dark-primary transition-all'>
