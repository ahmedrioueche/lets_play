                    ...
                    {success ? (
                      ...
                      <form onSubmit={handleSubmit} className='space-y-6'>
                        ...
                        <motion.button
                          type='submit'
                          disabled={isSubmitting}
                          className='w-full py-4 px-6 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white font-semibold rounded-lg shadow-lg transition-all duration-300 flex items-center justify-center gap-3 disabled:opacity-50 disabled:cursor-not-allowed'
                      ...
                      {contactMethods.map((method, index) => {
                        ...
                        return (
                          <motion.a
                            ...
                            className='block p-6 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-700 dark:to-gray-600 rounded-xl border border-gray-200 dark:border-gray-600 hover:shadow-lg transition-all duration-300 group'
                            whileHover={{ y: -5 }}
